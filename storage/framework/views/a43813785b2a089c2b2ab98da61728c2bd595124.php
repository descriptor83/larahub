...
<?php endif; ?>
        <div class="max-w-sm mx-auto">
            <form class="formpost" action="/admin/posts/<?php echo e($post->id); ?>/edit" method="post" enctype="multipart/form-data">
               <?php echo csrf_field(); ?>
               <?php echo method_field('PATCH'); ?>
        <div class="mb-6">
            <label class="block mb-2 uppecase font-bold text-gray-700" for="title">Title</label>
            <input class="border border-gray-400 p-2 w-full" type="text" name="title" id="title" value="<?php echo e(old('title') ? old('title') : $post->title); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <textarea class="border border-gray-400 p-2 w-full" type="text" name="excerpt" id="excerpt" required>
                <?php echo e(old('excerpt') ? old('excerpt') : $post->excerpt); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
           ...
           <textarea class="border border-gray-400 p-2 w-full" type="text" name="body" id="body" required>
            <?php echo e(old('body') ? old('body') : $post->body); ?>
...
unset($__errorArgs, $__bag); ?>
       ...
       <div class="mb-6">
           ...
           <input class="border border-gray-400 p-2 w-full" type="file" name="thumbnail" id="thumbnail" value="<?php echo e(old('thumbnail') ? old('thumbnail') : $post->thumbnail); ?>" >
           <img src="<?php echo e($post->thumbnail ?  asset('storage/'.$post->thumbnail) : asset('storage/lary-avatar.svg')); ?>" alt="thumbnail"width="56" height="63">
       ...
       <div class="mb-6">
           ...
           <select name="category_id" id="category_id">
               ...
               <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <option value="<?php echo e($category->id); ?>" <?php echo e($post->category_id == $category->id ? 'selected' : ''); ?> ><?php echo e(ucwords($category->name)); ?></option>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH /home/paul/Документы/www/lara_blog/resources/views/admin/posts/edit.blade.php ENDPATH**/ ?>