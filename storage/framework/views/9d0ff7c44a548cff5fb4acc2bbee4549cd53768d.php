...
<?php endif; ?>
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
            ...
            <div class="mb-6">
                ...
                <input class="border border-gray-400 p-2 w-full" type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>    <?php /**PATH /home/paul/Документы/www/lara_blog/resources/views/login.blade.php ENDPATH**/ ?>